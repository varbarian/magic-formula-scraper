...
try:
    ...
    url = 'https://chromedriver.storage.googleapis.com/{0}/{1}'.format(version, 'chromedriver_linux64.zip')
...
credentials = ServiceAccountCredentials.from_json_keyfile_name('/home/varban/.config/gspread/service_account.json', scope)
...
def writeSheet(names, tikrs):
    ...
    # access sheet by url
    wks = gc.open("mf_values").get_worksheet(0) # worksheet number
...
radio = driver.find_element(By.XPATH,'//input[@value="false" and contains(@name,"Select30")]')
radio.click()
